...
### Count of Benzodiazepine at Discharge
```{r}
...
Rate of Opioid and Benzodiazepine at Discharge {data-navmenu="Process Measures"}
==================================================

### Rate of Opioid and Benzodiazepine at Discharge
```{r}
...
qic(year_of_discharge, multiple_meds_at_discharge, n,
    ...
    subtitle = " Patients with more than one opioids OR at least one Opioid and One Benzodiazepine at discharge",
    show.grid = T,
    ylab      = NULL,
    xlab      = 'Year'
    )
...
# qic(year_of_discharge, readmissions, n,
...
# qic(year_of_discharge, readmission_60_days, n,
#     data      = readmissions_df,
#     chart     = 'p',
#     y.percent = TRUE,
#     title     = 'Readmissions within 60 days',
#     ylab      = NULL,
#     xlab      = 'Month'
# )
